...
from Tienda.views import crear_accesorios, listar_accesorios, listar_ropa, crear_ropa, search_ropa, listar_championes, crear_championes, crear_accesorios, detalle_ropa, detalle_championes, detalle_accesorios, delete_ropa, delete_championes, delete_accesorios
...
urlpatterns = [
    ...
    path('delete-ropa/<int:pk>/', delete_ropa, name = 'delete_ropa'),      
    ...
    path('delete-championes/<int:pk>/', delete_championes, name = 'delete_championes'),   
    ...
    path('delete-accesorios/<int:pk>/', delete_accesorios, name = 'delete_accesorios'),    
]